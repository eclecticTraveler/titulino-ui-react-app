...
class UnderConstruccion extends Component {
        ...
        <>
            <div className="titulino-modal">
                <div className="titulino-modal-content under-construction-modal-content justifyLeft">
                    ...
                    <Row gutter={[16, 16]}>
                        <Col xs={24} sm={12} md={8} className="upperTitleConstruction">
                            {/* You can add your image here */}
                        </Col>

                        <Col xs={24} sm={12} md={8} className="construction-icon">
                        ...
                        <Col xs={24} sm={24} md={8}>
                            <div className="mainTitle">
                                <strong className="innerPadding">{this.setLocale(locale, "under.construction.title")}</strong>
                            </div>
                        </Col>
                    </Row>

                    <Row gutter={[16, 16]}>
                        <Col xs={24} sm={24} md={24} className="innerColoredContainer underConstructionColoredContainer">
                            <div className="innercolorContainerProfile text-center">
                                <h3>{this.setLocale(locale, "under.construction.explanation")}</h3>
                            </div>
                        </Col>
                    </Row>

                    <Row gutter={[16, 16]}>
                        <Col xs={24} sm={24} md={24} className="underConstruccion contentTitle innerPadding">
                            <strong>{this.setLocale(locale, "under.construction.gratitute")}</strong>
                        </Col>
                    </Row>

                    <Row gutter={[16, 16]}>
                        <Col xs={24} sm={24} md={24} className="footerInformation">
