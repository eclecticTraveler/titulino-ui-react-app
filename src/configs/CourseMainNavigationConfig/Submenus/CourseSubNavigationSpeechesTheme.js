...
export const CourseSubNavigationSpeechesTheme = (lang) => {
	const commonPath = `${APP_PREFIX_PATH}/${lang}/${getLocalizedConfig(lang)?.level}-speeches/${getLocalizedConfig(lang)?.chapter}`;
	return [
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 1)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 2)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 3)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 4)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 5)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 6)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 7)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 8)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 9)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 10)
			]
		},
		{
			...
			breadcrumb: false,
			submenu: [
				...getCoursePracticeInnerSubMenuV2(lang, 'speeches', 11)
			]
		}
	]
}
