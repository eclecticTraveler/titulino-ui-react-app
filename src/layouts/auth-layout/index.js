...
export const AuthLayout = ({ navCollapsed, navType, location, direction, dynamicUpperMainNavigation, onCurrentRouteInfo }) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(React.memo(AuthLayout));