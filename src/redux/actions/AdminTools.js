...
export const onLoadingAdminToolsInit = async (emailId) => {
  const { allCourses, allRoles, allEnrollees } = await AdminToolsManager.initAdminTools(emailId);
  return { type: ON_LOADING_ADMIN_TOOLS_INIT, allCourses, allRoles, allEnrollees };
};
