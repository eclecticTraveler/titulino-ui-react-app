...
export const SET_USER_BASE_LANGUAGE = 'SET_USER_BASE_LANGUAGE';
export const GET_USER_BASE_LANGUAGE = 'GET_USER_BASE_LANGUAGE';
export const SET_USER_SELECTED_CONTENT_LANGUAGE = 'SET_USER_SELECTED_CONTENT_LANGUAGE';
export const GET_USER_SELECTED_CONTENT_LANGUAGE = 'GET_USER_SELECTED_CONTENT_LANGUAGE';
...
export const SET_USER_LANGUAGE_CONFIGURATION = 'SET_USER_LANGUAGE_CONFIGURATION';
export const GET_IS_LANGUAGE_CONFIGURED_FLAG = 'GET_IS_LANGUAGE_CONFIGURED_FLAG';
...
export const ON_VERIFYING_FOR_PROGRESS_BY_EMAIL_ID_COURSE_CODE_ID = 'ON_VERIFYING_FOR_PROGRESS_BY_EMAIL_ID_COURSE_CODE_ID';
export const ON_MODAL_INTERACTION = 'ON_MODAL_INTERACTION';
export const ON_LOADING_VIDEO_CLASS_ARRAY_URLS = 'ON_LOADING_VIDEO_CLASS_ARRAY_URLS';
export const ON_FETCHING_USER_AUTHENTICATED_PROGRESS_FOR_COURSE = 'ON_FETCHING_USER_AUTHENTICATED_PROGRESS_FOR_COURSE';
export const ON_VERIFYING_IF_USER_IS_ENROLLED_IN_COURSE = 'ON_VERIFYING_IF_USER_IS_ENROLLED_IN_COURSE';
export const ON_USER_SELECTING_CONTENT_LANGUAGE = 'ON_USER_SELECTING_CONTENT_LANGUAGE';
export const ON_UPSERTING_KNOW_ME_BY_CHAPTER = 'ON_UPSERTING_KNOW_ME_BY_CHAPTER';
export const ON_FETCHING_KNOW_ME_SURVEY_QUESTIONS = 'ON_FETCHING_KNOW_ME_SURVEY_QUESTIONS';
export const ON_RESOLVING_FACILITADOR_FOR_THEME_COURSE = 'ON_RESOLVING_FACILITADOR_FOR_THEME_COURSE';
export const ON_FETCHING_KNOW_ME_AI_RESULT = 'ON_FETCHING_KNOW_ME_AI_RESULT';
export const ON_FETCHING_KNOW_ME_AI_STATUS_BY_COURSE = 'ON_FETCHING_KNOW_ME_AI_STATUS_BY_COURSE';
export const ON_FETCHING_FLOATING_ACTIONS = 'ON_FETCHING_FLOATING_ACTIONS';